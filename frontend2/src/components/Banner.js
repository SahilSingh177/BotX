          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                <h1>{`Hi! I'm BotX ⚡`} </h1>
                  <h4>I'm a customisable discord Bot.</h4>
                  <br></br>
                  <i><q>Customisable means that anyone can set any command according to their choice ❤️. I also have lots of commands option.</q></i>
              </div>}
            </TrackVisibility>
          </Col>
          <Col xs={12} md={6} xl={5}>
